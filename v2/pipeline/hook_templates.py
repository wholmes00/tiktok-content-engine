...
def build_hook_template_prompt(product_brief, content_angles=None):
    ...
    lines.append("5. CATEGORY MIX (DATA-DRIVEN — enforced at selection):")
    lines.append("   - WARNING-category (avg 97K): AT LEAST 3 of 10 hooks")
    lines.append("   - CURIOSITY-category (avg 52K, most data): AT LEAST 3 of 10")
    lines.append("   - QUESTION-category (avg 58K): AT LEAST 1 of 10")
    lines.append("   - SHOCK-category (avg 78K): AT LEAST 1 of 10")
    lines.append("   This ensures the final 5 selected hooks span multiple categories.")
    lines.append("   Do NOT generate 8 curiosity hooks and 2 warning — SPREAD THEM.")
    lines.append("")
